...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-tesseract-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-tesseract-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-tesseract
# for installing globally
pixi global install r-tesseract
```
...
It is possible to list all of the versions of `r-tesseract` available on your platform:
...
```
pixi search r-tesseract --channel conda-forge
```
